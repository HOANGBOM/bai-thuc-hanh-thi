# cách 1 : Các mục từ được lưu trữ trong một mảng đã có thứ tự tăng dần theo mục từ. Một phần
# tử của mảng chứa một mục từ. Từ điển được lưu trong tập tin có tên là mãsinhviên_mang và các
# tập tin liên quan.
#
import json
tu_dien = {}
